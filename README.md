...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;git clone https://github.com/Lunerwalker2/FreightFrenzy1002.git</p>

* Or, if you prefer, you can use the "Download Zip" button available through this repository page.  Downloading the project as a .ZIP file will keep the size of the download manageable.
