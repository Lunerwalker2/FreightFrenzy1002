...
@TeleOp(name="Team Marker Pipeline Webcam Tester")
public class TeamMarkerPipelineWebcamTester extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //Create the camera object, for us a webcam
