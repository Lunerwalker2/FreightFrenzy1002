...
@TeleOp(name = "Tetra K-1.0")
class TetrahedralAxisTeleOp : LinearOpMode() {
...
//            val (x, y) = vector.rotated(angle)
            ...
            slowLock = gamepad1.a
            leftFrontPower = power * (gamepad1.left_stick_y + gamepad1.left_stick_x + gamepad1.right_stick_x)
            leftBackPower = power * (gamepad1.left_stick_y - gamepad1.left_stick_x + gamepad1.right_stick_x)
            rightFrontPower = power * (gamepad1.left_stick_y - gamepad1.left_stick_x - gamepad1.right_stick_x)
            rightBackPower = power * (gamepad1.left_stick_y + gamepad1.left_stick_x - gamepad1.right_stick_x)
