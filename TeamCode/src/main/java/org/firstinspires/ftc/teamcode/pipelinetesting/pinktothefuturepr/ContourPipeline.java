...
public class ContourPipeline extends OpenCvPipeline
{
    ...
    private double borderBottomY = 0.0;   //amounfractiont of pixels from the bottom of the cam to skip
    ...
    public double getAspectRatio(){synchronized (sync) { return getRectArea()/(CAMERA_HEIGHT*CAMERA_WIDTH); }}
